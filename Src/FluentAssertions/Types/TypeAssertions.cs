...
public class TypeAssertions : ReferenceTypeAssertions<Type, TypeAssertions>
{
    ...
    {
        string expectedType = TypeValueFormatter.Format(expected);
        string actualType = TypeValueFormatter.Format(actual);
    ...
    {
        return string.Join(", ", parameterTypes.Select(TypeValueFormatter.Format));
    }
