...
public partial class CollectionAssertionSpecs
{
    ...
    public class NotEqualApproximately
    {
        ...
        public void Two_null_collections_cannot_be_compared()
        {
            ...
            // Act / Assert
            nullColl.Should().NotEqualApproximately(unexpected: null, 0.1f);
        }
        ...
        public void Subject_collection_cannot_be_null_if_expectation_is_not_null()
        {
            ...
            // Assert
            act.Should().Throw<XunitException>().Which.Message.Should().Be(
                "Expected collection to not approximate {1F, 2F, 3F} by ± 0.1F because we want to test the failure message, but found <null>.");
        }
