...
#pragma warning restore CA1065
    ...
    public void When_a_multi_dimensional_array_is_compared_to_null_it_should_throw()
    {
        ...
        act.Should().Throw<XunitException>().WithMessage("Cannot compare a multi-dimensional array to <null>*");
    }
    ...
    public void When_a_multi_dimensional_array_is_compared_to_a_non_array_it_should_throw()
    {
        ...
        act.Should().Throw<XunitException>().WithMessage("Cannot compare a multi-dimensional array to something else*");
    }
    ...
    public void When_the_length_of_the_2nd_dimension_differs_between_the_arrays_it_should_throw()
    {
        ...
        act.Should().Throw<XunitException>().WithMessage("Expected dimension 0 to contain 1 item(s), but found 2*");
    }
...
#pragma warning restore format
    ...
    public void When_the_subject_contains_less_items_than_expected_it_should_throw()
    {
        ...
        action.Should().Throw<XunitException>().WithMessage("*subject*to be a collection with 2 item(s), but*contains 1 item(s) less than*");
    }
    ...
    public void When_the_subject_contains_more_items_than_expected_it_should_throw()
    {
        ...
        action.Should().Throw<XunitException>().WithMessage("Expected subject*to be a collection with 1 item(s), but*contains 1 item(s) more than*");
    }
    ...
    public void When_the_subject_contains_same_number_of_items_but_expectation_contains_duplicates_it_should_throw()
    {
        ...
        action.Should().Throw<XunitException>().WithMessage("Expected property subject[1].Name*to be *actual*\"Jane\" *\"John\"*expected*");
    }
    ...
    public void When_the_subject_contains_same_number_of_items_but_subject_contains_duplicates_it_should_throw()
    {
        ...
        action.Should().Throw<XunitException>().WithMessage("Expected property subject[1].Name*to be *actual*\"John\" *\"Jane\"*expected*");
    }
    ...
    public void When_two_unordered_lists_are_structurally_equivalent_and_order_is_strict_it_should_fail()
    {
        ...
        action.Should().Throw<XunitException>().WithMessage("Expected property subject[0].Name*John*Jane*subject[1].Name*Jane*John*");
    }
